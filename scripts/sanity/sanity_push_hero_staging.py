...
PROJECT_ID = "89a9k63v"
DATASET = "staging"
DOC_ID = "b8feb522-f902-4fa6-bbc1-92724e3df508"  # hero document
...
# New headline: "Stop wrangling data. Start getting answers."
# Using the existing bold format pattern from the site (* for bold/italic in Sanity)
new_headline = "Stop *wrangling* data. <br> Start getting *answers.*"
